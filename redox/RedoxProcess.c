...
static void RedoxProcess_rowWriteField(const Row* super, RichString* str, ProcessField field) {
   const RedoxProcess* up = (const RedoxProcess*) super;
...
const ProcessClass RedoxProcess_class = {
   .super = {
      ...
      .writeField = RedoxProcess_rowWriteField
   },
